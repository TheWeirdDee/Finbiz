...
export default function Home() {
  return (
    <section className="bg-[#1D1C20] mt-10 text-white flex flex-col items-center justify-center min-h-screen px-6">
      {/* Tag */}
      <div className="bg-[#171F05] flex items-center gap-2 border border-[#364C09] text-[#A3DC2F] text-sm px-4 py-1 rounded-full mb-4">
